<?php 
	...
	$result = C::t('cigar_brands')->fetch_data();
	$types_without_search = C::t('cigar_types')->types_without_search();
	$type_result = C::t('cigar_types')->fetch_data();
	$origin_result = C::t('cigar_origins')->fetch_data();
                      ...
                      <table  class="table table-datatable table-custom" id="basicDataTable">
                        <thead>
            				<tr>
								...
								<th class="sort-alpha">品牌名字</th>
								<th class="sort-alpha">品牌类型</th>
							</tr>
						...
						<?php 
						    ...
						    foreach ($result as $index => $row){
						        ...
						        $id = $row['bid'];
						        $name = $row['value'];
						        $type = C::t('cigar_types')->fetch($row['type'])['value'];
						        echo <<<EOT
						<tr>
...
EOT;
				    ...
				    <div class="modal fade" id="modalConfirm" tabindex="-1" role="dialog" aria-labelledby="modalConfirmLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <form role="form" name="form_add" action="action.php?action=brand_manager&handle=add" method="post" enctype="multipart/form-data" parsley-validate >
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">Close</button>
                          ...
                          <div class="modal-body">
                              ...
                              <div class="form-group">
                                <label for="passwordInput">品牌名字：</label>
                                <input type="text" class="form-control" id="passwordInput" name="name" parsley-trigger="change" parsley-required="true"  parsley-required-message="请输入品牌名字"/>
                              </div>

    	                      <div class="form-group">
                                <label for="input07" class="control-label">品牌类型：</label>
                                <select class="chosen-select form-control" name="type" id="input07">
                                    <?php 
                                    foreach ($types_without_search as $row){
                                        
                                        echo <<<EOT
<option value="{$row['tid']}">{$row['value']}</option>
EOT;
                    ...
                    <div class="modal fade" id="updateModalConfirm" tabindex="-1" role="dialog" aria-labelledby="modalConfirmLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <form role="form" name="form_add" action="action.php?action=brand_manager&handle=update" method="post" enctype="multipart/form-data" parsley-validate >
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">Close</button>
              ...
              <div class="col-md-8">
                ...
                <section class="tile color transparent-black">
                  ...
                  <div class="tile-body">
                    ...
                    <div class="table-responsive">
                      <table  class="table table-datatable table-custom" id="ori_basicDataTable">
                        <thead>
            				<tr>
								<th class="text-center">
            					    <input type="checkbox" id="ori_select_all">
                                    <label for="select_all">全选</label>
                                </th>
								<th class="sort-numeric" >序号</th>
								<th class="sort-alpha">产地名字</th>
							</tr>
						...
						<?php 
						    ...
						    foreach ($origin_result as $index => $row){
						    	$i = $index + 1;
						        $name = $row['value'];
								
						        echo <<<EOT
						<tr>
		                    <td class="text-center"><input type="checkbox" id="{$row['oid']}"/></td>
		                    <td>$i</td>
		                    <td>$name</td>
						</tr>
EOT;
                        ...
                        <div class="modal fade" id="ori_delete_Confirm" tabindex="-1" role="dialog" aria-labelledby="modalDialogLabel" aria-hidden="true">
					      <div class="modal-dialog">
					        <div class="modal-content">
					          <div class="modal-header">
					            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">Close</button>
					          ...
					          <div class="modal-footer">
	                            <button class="btn btn-red" data-dismiss="modal" aria-hidden="true">取消</button>
	                            <button class="btn btn-green" id="ori_delete_confirm_btn" data-dismiss="modal" >确定</button>
                            </div>
					        </div><!-- /.modal-content -->
					      </div><!-- /.modal-dialog -->
					    </div><!-- /.modal -->
				    ...
				    <div class="modal fade" id="ori_modalConfirm" tabindex="-1" role="dialog" aria-labelledby="modalConfirmLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <form role="form" name="form_add" action="action.php?action=origin_manager&handle=add" method="post" enctype="multipart/form-data" parsley-validate >
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">Close</button>
                            <h3 class="modal-title" id="modalConfirmLabel">添加</h3>
                          </div>
                          <div class="modal-body">
                              ...
                              <div class="form-group">
                                <label for="passwordInput">产地名字：</label>
                                <input type="text" class="form-control" id="passwordInput" name="name" parsley-trigger="change" parsley-required="true"  parsley-required-message="请输入品牌名字"/>
                              </div>
                    ...
                    <div class="modal fade" id="ori_updateModalConfirm" tabindex="-1" role="dialog" aria-labelledby="modalConfirmLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <form role="form" name="form_add" action="action.php?action=origin_manager&handle=update" method="post" enctype="multipart/form-data" parsley-validate >
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">Close</button>
                            <h3 class="modal-title" id="modalConfirmLabel">修改</h3>
                          </div>
                          ...
                          <input type="hidden" id="ori_flag" name="flag" value="-1" />
                         </form>
                        </div><!-- /.modal-content -->
                      </div><!-- /.modal-dialog -->
                    </div><!-- /.modal -->   
              ...
              <div class="col-md-4">
                ...
                <section class="tile color transparent-black">
                  ...
                  <div class="tile-body">
                    ...
                    <div class="table-responsive">
                      <table  class="table table-datatable table-custom" id="type_basicDataTable">
                        <thead>
            				<tr>
								<th class="text-center">
            					    <input type="checkbox" id="type_select_all">
                                    <label for="type_select_all">全选</label>
                                </th>
								<th class="sort-numeric" >序号</th>
								<th class="sort-alpha">类型名称</th>
							</tr>
						...
						<?php 
						    ...
						    foreach ($type_result as $index => $row){
						    	$i = $index + 1;
						        $name = $row['value'];
						        echo <<<EOT
						<tr>
		                    <td class="text-center"><input type="checkbox" id="{$row['tid']}"/></td>
		                    <td>$i</td>
                            <td>$name</td>
						</tr>
EOT;
                    ...
                    <div class="modal fade" id="type_updateModalConfirm" tabindex="-1" role="dialog" aria-labelledby="modalConfirmLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <form role="form" name="form_add" action="action.php?action=origin_manager&handle=update" method="post" enctype="multipart/form-data" parsley-validate >
                          <div class="modal-header">
                          ...
                          <div class="modal-body">
                         	 ...
                         	 <div class="form-group">
                                <label for="passwordInput">类型名字：</label>
                                <input type="text" class="form-control" id="passwordInput" name="name" parsley-trigger="change" parsley-required="true"  parsley-required-message="请输入类型名字"/>
                              </div>
                          ...
                          <input type="hidden" id="type_flag" name="flag" value="-1" />
                         </form>
                        </div><!-- /.modal-content -->
                      </div><!-- /.modal-dialog -->
                    </div><!-- /.modal -->   
...
//             oTable01.$('tr.row_selected').removeClass('row_selected');
       ...
       $("#basicDataTable tbody tr").dblclick(function(e){
         ...
         $.post('simple_query.php',{'info': 'update','type': 'brand_manager','id': id},function(data){
					...
					// ok ，整理form
					var model = eval('(' + data + ')');
					$('#updateModalConfirm input[name=name]').val(model.value);
					$('#updateModalConfirm select').val(model.type);
...
//			var id_array = new Array();
        ...
        $('#delete_confirm_btn').click(function(){
        	...
        	$.post('action.php?action=brand_manager&handle=del',{'id_array': id_array.join(',')},function(data){
...
//					alert('删除失败： ' + data);
        ...
        // type DataTable.
        var oTable02 = $('#type_basicDataTable').dataTable({
          "sDom":
            "R<'row'<'col-md-6'l><'col-md-6'f>r>"+
            "t"+
            "<'row'<'col-md-4 sm-center'i><'col-md-4'><'col-md-4 text-right sm-center'p>>",
         ...
         /* Double Click. */
       $("#type_basicDataTable tbody tr").dblclick(function(e){
         $.jGrowl("正在获取数据中");
         ...
         $.post('simple_query.php',{'info': 'update','type': 'type_manager','id': id},function(data){
					if(data.hasOwnProperty('result')){
						if(data.result == '-1'){
							$.jGrowl('参数有误    #1');
						}else if(data.result == '-2'){
					...
					// ok ，整理form
					var model = eval('(' + data + ')');
					$('#type_updateModalConfirm input[name=name]').val(model.value);
					
					$('#type_flag').val(id);
					$('#type_open_update_modal').click();
				}).error(function(){
					$.jGrowl('请求数据失败，请重试');
				});
       ...
       /* Add a click handler to the rows - this could be used as a callback */
        $("#type_basicDataTable tbody tr").click( function( e ) {
          if ( $(this).hasClass('row_selected') ) {
            $(this).removeClass('row_selected');
            $(this).find('input[type=checkbox]:eq(0)').get(0).checked = false;
          }
...
//             oTable01.$('tr.row_selected').removeClass('row_selected');
   		...
   		$('#type_select_all').click(function(){
			var flag = this.checked;
				$('#type_basicDataTable tbody :checkbox').each(function (){
					this.checked = flag;
			});
		});
       ...
       // origin DataTable.
        var oTable03 = $('#ori_basicDataTable').dataTable({
          "sDom":
            "R<'row'<'col-md-6'l><'col-md-6'f>r>"+
            "t"+
            "<'row'<'col-md-4 sm-center'i><'col-md-4'><'col-md-4 text-right sm-center'p>>",
         ...
         /* Double Click. */
       $("#ori_basicDataTable tbody tr").dblclick(function(e){
         $.jGrowl("正在获取数据中");
         ...
         $.post('simple_query.php',{'info': 'update','type': 'origin_manager','id': id},function(data){
					if(data.hasOwnProperty('result')){
						if(data.result == '-1'){
							$.jGrowl('参数有误    #1');
						}else if(data.result == '-2'){
       ...
       /* Add a click handler to the rows - this could be used as a callback */
        $("#ori_basicDataTable tbody tr").click( function( e ) {
          if ( $(this).hasClass('row_selected') ) {
            $(this).removeClass('row_selected');
            $(this).find('input[type=checkbox]:eq(0)').get(0).checked = false;
          }
...
//             oTable01.$('tr.row_selected').removeClass('row_selected');
        ...
        $('#ori_select_all').click(function(){
			var flag = this.checked;
				$('#ori_basicDataTable tbody :checkbox').each(function (){
					this.checked = flag;
			});
		});
		
		// Append delete button to table
        var oper = '<div class="col-sm-offset-1 col-sm-6" id="ori_oper" ></div>';
        $('#ori_basicDataTable_wrapper .row .col-md-6:eq(0)').append(oper);
        var addLink = '<a href="#ori_modalConfirm" id="add" data-toggle="modal"  class="btn btn-orange m_r_5">添加</a>';
        $('#ori_oper').append(addLink);
        var updateLink = '<button type="button" id="update" class="btn btn-green m_r_5">修改</button>';
        $('#ori_oper').append(updateLink);
        var deleteRowLink = '<a href="#ori_delete_Confirm" data-toggle="modal" id="ori_deleteRow" class="btn btn-red">删除选中行</a>'
        $('#ori_oper').append(deleteRowLink);
        
        
		var ori_id_array = new Array();
        /* Add a click handler for the delete row */
        $('#ori_deleteRow').click( function() {
			
			ori_id_array = [];

//			var id_array = new Array();
			
			$('#ori_basicDataTable input[type=checkbox]:checked').each(function(){
				var v = $(this).attr('id');
				if(!v || isNaN(v)){
					return ;
				}
			...
			if(ori_id_array.length == 0){
				$('#ori_detele_tip').html('并没有选中任何数据。');
			}else{
				$('#ori_detele_tip').html('确定要删除这' + ori_id_array.length + '条数据么？');
			}
			
        });
        
        $('#ori_delete_confirm_btn').click(function(){
        	
        	if(ori_id_array.length == 0){
        		return ;
        	}
        	
        	$.post('action.php?action=origin_manager&handle=del',{'id_array': ori_id_array.join(',')},function(data){
				if(isNaN(data) || data== '' || data == 0){
//					alert('删除失败： ' + data);
					$.jGrowl(data, { header: '删除失败', sticky: true });		
				}else{
