<?php 
    ...
    $result = C::t('cigar_zhenwo')->fetch_data_flag_admin();
                      ...
                      <table  class="table table-datatable table-custom" id="basicDataTable">
                        <thead>
            				<tr>
            					...
            					<th class="sort-alpha">链接</th>
            					<th class="sort-alpha">插入时间</th>
            				</tr>
            			</thead>
...
EOT;
				...
				?>
				    ...
				    <div class="modal fade" id="modalConfirm" tabindex="-1" role="dialog" aria-labelledby="modalConfirmLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <form role="form" name="form_add" action="action.php?action=zhenwo_manage&handle=add" method="post" enctype="multipart/form-data" parsley-validate >
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">Close</button>
                          ...
                          <div class="modal-body">
                              ...
                              <div class="form-group">
                                <label for="passwordInput">链接：</label>
                                <input type="text" class="form-control" id="passwordInput" name="link" parsley-trigger="change" parsley-required="true" parsley-required-message="请输入名字"  >
                              </div>
                    ...
                    <div class="modal fade" id="updateModalConfirm" tabindex="-1" role="dialog" aria-labelledby="modalConfirmLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <form role="form" name="form_update" action="action.php?action=zhenwo_manage&handle=update" method="post" enctype="multipart/form-data" parsley-validate >
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">Close</button>
                          ...
                          <div class="modal-body">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                              ...
                              <div class="form-group">
                                <label for="placeholderInput">链接：</label>
                                <input type="text" class="form-control" id="placeholderInput" name="link" parsley-required="true" parsley-trigger="change" parsley-required-message="请输入雪茄名字" > 
                              </div>
...
//        }
       ...
       $("#basicDataTable tbody tr").dblclick(function(e){
         ...
         $.post('simple_query.php',{'info': 'update','type': 'zhenwo_manage','id': id},function(data){
					...
					$('#updateModalConfirm input[name=link]').val(model.link);

					var img = model.image.toString();
...
//			var id_array = new Array();
        ...
        $('#delete_confirm_btn').click(function(){
        	...
        	$.post('action.php?action=zhenwo_manage&handle=del',{'id_array': id_array.join(',')},function(data){
