<?php 
	...
	$result = C::t('cigar_footer')->fetch_data();
                  ...
                  <div class="tile-body color transparent-black rounded-corners">
                    ...
                    <div class="table-responsive">
                      <table  class="table table-datatable table-custom" id="basicDataTable">
                        <thead>
            				<tr>
            					<th class="text-center">全选<input type="checkbox" id="select_all" /></th>
            					<th class="sort-numeric">序号</th>
            					<th>图片</th>
            					<th class="sort-alpha">超链接地址</th>
            					<th>位置</th>					
            				</tr>
            			</thead>
                        ...
                        <tbody>
            				...
            				<?php 
            				    foreach ($result as $index => $row){
            				        ...
            				        if ($row['postion'] == -1){
            				            $p = '左边';
            				        }else if ($row['postion'] == 0){
            				            $p = '中间';
            				        }else if ($row['postion'] == 1){
            				            $p = '右边';
            				        }
...
EOT;
				    ...
				    <div class="modal fade" id="modalConfirm" tabindex="-1" role="dialog" aria-labelledby="modalConfirmLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <form role="form" name="form_add" action="action.php?action=foot_images&handle=add" method="post" enctype="multipart/form-data" parsley-validate >
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">Close</button>
                          ...
                          <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
		                          <span class="input-group-btn">
		                            <span class="btn btn-primary btn-file">
		                              <i class="fa fa-upload"></i><input type="file" name="img" onchange="PreviewImage(this,'imgView','divNewPreview',140,140)" >
		                            </span>
		                          </span>
                              ...
                              <div class="form-group">
                                <label for="passwordInput">超链接地址：</label>
                                <input type="text" class="form-control" id="passwordInput" name="url" parsley-trigger="change" parsley-required="true"  parsley-required-message="请输入超链接地址"/>
                              </div>

                              <div class="form-group">
                                <label for="placeholderInput margin-right-20">显示位置：</label>
                                <div class="btn-group">
		                            <button type="button" class="btn btn-greensea" value="left">左边</button>
		                            <button type="button" class="btn btn-orange" value="middle">中间</button>
		                            <button type="button" class="btn btn-greensea" value="right">右边</button>
		                         </div>
		                         <input type="hidden" name="pos" value="middle" />
                              </div>
                    ...
                    <div class="modal fade" id="updateModalConfirm" tabindex="-1" role="dialog" aria-labelledby="modalConfirmLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <form role="form" name="form_add" action="action.php?action=foot_images&handle=update" method="post" enctype="multipart/form-data" parsley-validate >
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">Close</button>
                          ...
                          <div class="modal-body">
                              ...
                              <div class="form-group">
                                ...
                                <div class="input-group">
		                          <span class="input-group-btn">
		                            <span class="btn btn-primary btn-file">
		                              <i class="fa fa-upload"></i><input type="file" name="img"  onchange="PreviewImage(this,'imgViewU','divNewPreviewU',140,140)" >
		                            </span>
		                          </span>
...
//        }
       ...
       $("#basicDataTable tbody tr").dblclick(function(e){
         ...
         $.post('simple_query.php',{'info': 'update','type': 'foot_images','id': id},function(data){
					...
					var str = '#updateModalConfirm .btn-group .btn:eq('+(parseInt(model.postion)+1)+')';
					$(str).click();
					$('#flag').val(id);
...
//			var id_array = new Array();
        ...
        $('#delete_confirm_btn').click(function(){
        	...
        	$.post('action.php?action=foot_images&handle=del',{'id_array': id_array.join(',')},function(data){
