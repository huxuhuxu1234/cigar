<?php 
	...
	$result = C::t('cigar_search')->fetch_data();
                      ...
                      <table  class="table table-datatable table-custom" id="basicDataTable">
                        <thead>
            				<tr>
            					...
            					<th class="sort-alpha">显示内容</th>
            					<th class="sort-alpha">筛选条件内容</th>
...
EOT;
				    ...
				    <div class="modal fade" id="modalConfirm" tabindex="-1" role="dialog" aria-labelledby="modalConfirmLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <form role="form" name="form_add" action="action.php?action=search&handle=add" method="post" parsley-validate >
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">Close</button>
                          ...
                          <div class="modal-body">
                              ...
                              <div class="form-group">
                                <label for="passwordInput">显示内容：</label>
                                <input type="text" class="form-control" id="passwordInput" name="word" parsley-trigger="change" parsley-required="true" parsley-required-message="请输入显示内容"  >
                              </div>

                              <div class="form-group">
                                <label for="placeholderInput">搜索条件</label>
                                <input type="text" class="form-control" id="placeholderInput" name="condition" parsley-required="true" parsley-trigger="change" parsley-required-message="请输入正确的搜索条件" > 
                              </div>
                    ...
                    <div class="modal fade" id="updateModalConfirm" tabindex="-1" role="dialog" aria-labelledby="modalConfirmLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <form role="form" name="form_add" action="action.php?action=search&handle=update" method="post" parsley-validate >
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">Close</button>
...
//        }
       ...
       $("#basicDataTable tbody tr").dblclick(function(e){
         ...
         $.post('simple_query.php',{'info': 'update','type': 'search','id': id},function(data){
					...
					// ok ，整理form   word,condition
					var model = eval('(' + data + ')');
					$('#updateModalConfirm input[name=word]').val(model.word);
					$('#updateModalConfirm input[name=condition]').val(model.condition);
					$('#flag').val(id);
...
//			var id_array = new Array();
        ...
        $('#delete_confirm_btn').click(function(){
        	...
        	$.post('action.php?action=search&handle=del',{'id_array': id_array.join(',')},function(data){
