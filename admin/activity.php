<?php 
	...
	$result = C::t('cigar_activity')->fetch_data();
                  ...
                  <div class="tile-body color transparent-black rounded-corners">
                    ...
                    <div class="table-responsive">
                      <table  class="table table-datatable table-custom" id="basicDataTable">
                        <thead>
                        <!-- username,uid,title,content,publish_time -->
            				<tr>
...
EOT;
				    ...
				    <div class="modal fade" id="modalConfirm" tabindex="-1" role="dialog" aria-labelledby="modalConfirmLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <form role="form" name="form_add" action="action.php?action=activity&handle=add" method="post" parsley-validate >
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">Close</button>
                          ...
                          <!--  title,content  -->
                              ...
                              <div class="form-group">
                                <label for="passwordInput">超链接：</label>
                                <input type="text" class="form-control" id="passwordInput" name="url" parsley-trigger="change" parsley-required="true"  parsley-required-message="请输入超链接" >
                              </div>

                              <div class="form-group">
                                <label for="placeholderInput">内容：</label>
                    ...
                    <div class="modal fade" id="updateModalConfirm" tabindex="-1" role="dialog" aria-labelledby="modalConfirmLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <form role="form" name="form_update" action="action.php?action=activity&handle=update" method="post" parsley-validate >
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">Close</button>
...
//        }
       ...
       $("#basicDataTable tbody tr").dblclick(function(e){
         ...
         $.post('simple_query.php',{'info': 'update','type': 'activity','id': id},function(data){
...
//			var id_array = new Array();
        ...
        $('#delete_confirm_btn').click(function(){
        	...
        	$.post('action.php?action=activity&handle=del',{'id_array': id_array.join(',')},function(data){
