<?php 
	...
	$result = C::t('cigar_culture_ad')->fetch_data();
                      ...
                      <table  class="table table-datatable table-custom" id="basicDataTable">
                        <thead>
            				...
            				<tr>
            					...
            					<th class="sort-alpha">地址</th>
            					<th>图片</th>
            					<th class="sort-numeric">开始时间</th>
            					<th class="sort-numeric">结束时间</th>
            					<th class="sort-alpha">显示位置</th>
            				</tr>
            			</thead>
...
EOT;
				...
				?>
				    ...
				    <div class="modal fade" id="modalConfirm" tabindex="-1" role="dialog" aria-labelledby="modalConfirmLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <form role="form" name="form_add" action="action.php?action=culture_ad&handle=add" method="post" enctype="multipart/form-data" parsley-validate >
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">Close</button>
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <div class="input-group">
		                          ...
		                          <input type="text" class="form-control" readonly="" parsley-required="true" parsley-error-message="请选择图片文件！ 如果已经选择，请无视此提示">
		                        </div>
                              </div>

                              <div class="form-group">
                                <label for="">链接地址：</label>
                                <input type="text" class="form-control" id="passwordInput" name="url" parsley-trigger="change" parsley-required="true" parsley-required-message="请输入链接地址"  >
                              </div>

                              <div class="form-group">
                                <label for="">显示位置</label>
                                <input type="text" class="form-control" id="placeholderInput" name="order" parsley-required="true" parsley-trigger="change" parsley-type="number" parsley-required-message="请输入显示位置" parsley-type-message="请输入正确的数字(1,2,3)"> 
                              </div>
                              
                              <div class="form-group">
                                <label for="datepicker" class="control-label">起始时间：</label>
                                <div >
                                  <input type="text" name="start_time" class="form-control" id="datepicker" parsley-trigger="change" parsley-required="true" parsley-required-message="请输入起始时间">
                                </div>
                              </div>
                              
                               <div class="form-group">
                                <label for="datepicker2" class="control-label">结束时间：</label>
                                <div >
                                  <input type="text" name="end_time" class="form-control" id="datepicker2" parsley-trigger="change" parsley-required="true" parsley-required-message="请输入结束时间" >
                                </div>
                              </div>
                    ...
                    <div class="modal fade" id="updateModalConfirm" tabindex="-1" role="dialog" aria-labelledby="modalConfirmLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <form role="form" name="form_add" action="action.php?action=culture_ad&handle=update" method="post" enctype="multipart/form-data" parsley-validate >
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">Close</button>
                          ...
                          <div class="modal-body">
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                <label for="datepicker" class="control-label">起始时间：</label>
                                <div >
                                  <input type="text" name="start_time" class="form-control" id="datepicker3" parsley-trigger="change" parsley-required="true" parsley-required-message="请输入起始时间">
                                </div>
                              </div>
                               ...
                               <div class="form-group">
                                <label for="datepicker2" class="control-label">结束时间：</label>
                                <div >
                                  <input type="text" name="end_time" class="form-control" id="datepicker4" parsley-trigger="change" parsley-required="true" parsley-required-message="请输入结束时间" >
                                </div>
                              </div>
...
//        }
       ...
       $("#basicDataTable tbody tr").dblclick(function(e){
         ...
         $.post('simple_query.php',{'info': 'update','type': 'culture_ad','id': id},function(data){
					...
					// ok ，整理form
					var model = eval('(' + data + ')');
					$('#updateModalConfirm input[name=url]').val(model.url);
					$('#updateModalConfirm input[name=order]').val(model.position);
					$('#updateModalConfirm input[name=start_time]').val(model.startTime);
					$('#updateModalConfirm input[name=end_time]').val(model.endTime);
...
//			var id_array = new Array();
        ...
        $('#delete_confirm_btn').click(function(){
        	...
        	$.post('action.php?action=culture_ad&handle=del',{'id_array': id_array.join(',')},function(data){
