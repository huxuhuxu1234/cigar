<?php 
	...
	$result = C::t('cigar_images_index')->fetch_data();
                      ...
                      <table  class="table table-datatable table-custom" id="basicDataTable">
                        <thead>
            				<tr>
            					...
            					<th class="sort-numeric">图片</th>
            					<th class="sort-alpha">超链接地址</th>
            					<th class="sort-numeric">显示时长(秒)</th>
...
EOT;
				    ...
				    <div class="modal fade" id="modalConfirm" tabindex="-1" role="dialog" aria-labelledby="modalConfirmLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <form role="form" name="form_add" action="action.php?action=index_images&handle=add" method="post" enctype="multipart/form-data" parsley-validate >
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">Close</button>
                          ...
                          <div class="modal-body">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="passwordInput" name="url" parsley-trigger="change" parsley-required="true" parsley-required-message="请输入显示时长" >
                              </div>
                              
                              <div class="form-group">
                                <label for="passwordInput">显示时长(秒)：</label>
                                <input type="text" class="form-control" id="passwordInput" name="time" parsley-trigger="change" parsley-required="true" parsley-type="number" parsley-required-message="请输入显示时长" parsley-type-message="请输入正确的数字" >
                              </div>
                    ...
                    <div class="modal fade" id="updateModalConfirm" tabindex="-1" role="dialog" aria-labelledby="modalConfirmLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <form role="form" name="form_add" action="action.php?action=index_images&handle=update" method="post" enctype="multipart/form-data" parsley-validate >
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">Close</button>
...
//        }
       ...
       $("#basicDataTable tbody tr").dblclick(function(e){
         ...
         $.post('simple_query.php',{'info': 'update','type': 'index_images','id': id},function(data){
...
//			var id_array = new Array();
        ...
        $('#delete_confirm_btn').click(function(){
        	...
        	$.post('action.php?action=index_images&handle=del',{'id_array': id_array.join(',')},function(data){
