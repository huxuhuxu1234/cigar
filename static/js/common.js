...
function showWindow(k, url, mode, cache, menuv) {
	...
	if(!menuObj) {				var my_js = '';				if(k == 'login'){		  		  my_js = 'style="display: inline-block; margin-top: -265px;"'				}
		menuObj = document.createElement('div');
		menuObj.id = menuid;
		menuObj.className = 'fwinmask';
		menuObj.style.display = 'none';
		...
		menuObj.innerHTML = hidedom + '<table '+my_js+' cellpadding="0" cellspacing="0" class="fwin"><tr><td class="t_l"></td><td class="t_c"' + evt + '></td><td class="t_r"></td></tr><tr><td class="m_l"' + evt + ')">&nbsp;&nbsp;</td><td class="m_c" id="fwin_content_' + k + '">'
