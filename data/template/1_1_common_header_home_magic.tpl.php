...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1443080395, '1', './data/template/1_1_common_header_home_magic.tpl.php', './template/default', 'common/header_home_magic')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1443080395, '1', './data/template/1_1_common_header_home_magic.tpl.php', './template/default', 'common/header_home_magic')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1443080395, '1', './data/template/1_1_common_header_home_magic.tpl.php', './template/default', 'common/header_home_magic')
;?>
