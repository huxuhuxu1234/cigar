...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1457163110, '1', './data/template/1_1_common_header_misc_tag.tpl.php', './template/default', 'common/header_misc_tag')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1457163110, '1', './data/template/1_1_common_header_misc_tag.tpl.php', './template/default', 'common/header_misc_tag')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1457163110, '1', './data/template/1_1_common_header_misc_tag.tpl.php', './template/default', 'common/header_misc_tag')
;?>
