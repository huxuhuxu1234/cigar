...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1444890692, '1', './data/template/1_1_common_header.tpl.php', './template/default', 'common/header')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1444890692, '1', './data/template/1_1_common_header.tpl.php', './template/default', 'common/header')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1444890692, '1', './data/template/1_1_common_header.tpl.php', './template/default', 'common/header')
;?>
