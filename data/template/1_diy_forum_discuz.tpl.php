...
<?php if(empty($gid)) { ?>
<div class="wp">
<!--[diy=diy1]--><div id="diy1" class="area"><div id="frame1nLEsy" class="frame move-span cl frame-1-1-1"><div class="title frame-title"><span class="titletext">1-1-1框架</span></div><div id="frame1nLEsy_left" class="column frame-1-1-1-l"><div id="frame1nLEsy_left_temp" class="move-span temp"></div></div><div id="frame1nLEsy_center" class="column frame-1-1-1-c"><div id="frame1nLEsy_center_temp" class="move-span temp"></div></div><div id="frame1nLEsy_right" class="column frame-1-1-1-r"><div id="frame1nLEsy_right_temp" class="move-span temp"></div><div id="tabFdd435" class=" frame-tab move-span cl"><div id="tabFdd435_title" class="tab-title title column cl" switchtype="click"><span class="titletext">最新会员</span><span class="subtitle">积分排行</span></div><div id="tabFdd435_content" class="tb-c"></div><script type="text/javascript">initTab("tabFdd435","click");</script></div></div></div></div><!--[/diy]-->
</div>
<?php } ?>
