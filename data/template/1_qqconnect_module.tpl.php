...
<p><a href="{$_G['connect']['login_url']}&statfrom=login_simple"><img src="{$__IMGDIR}/qq_login.png" class="vm" alt="QQ登录" /></a></p>
...
<span class="pipe">|</span><a href="connect.php?mod=config" target="_blank"><img src="{$__IMGDIR}/qq_bind_small.png" class="qq_bind" align="absmiddle" alt="QQ绑定" /></a>
...
<a href="{$_G['connect']['login_url']}&statfrom=login" target="_top" rel="nofollow"><img src="{$__IMGDIR}/qq_login.png" class="vm" /></a>
