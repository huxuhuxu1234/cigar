...
0
|| checktplrefresh('./template/default/member/register.htm', './template/default/common/seccheck.htm', 1443079216, '1', './data/template/1_1_member_register.tpl.php', './template/default', 'member/register')
...
<button class="pn pnc" id="registerformsubmit" type="submit" name="regsubmit" value="true" tabindex="1" style="background-image: url(); background: #f49800;border-color: #CCC;"><strong><?php if($_GET['action'] == 'activation') { ?>激活<?php } else { ?>提交<?php } ?></strong></button>
<?php if($bbrules) { ?>
