...
0
|| checktplrefresh('./template/default/member/login.htm', './template/default/common/seccheck.htm', 1443079565, '1', './data/template/1_1_member_login.tpl.php', './template/default', 'member/login')
...
<th>&nbsp;</th>
<td>
<button class="pn pnc" type="submit" name="loginsubmit" value="true" tabindex="1" style="background-image: url(); background: #f49800;border-color: #CCC;"><strong>登录</strong></button>
</td>
<td>
