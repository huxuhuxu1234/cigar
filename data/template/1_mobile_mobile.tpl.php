...
0
|| checktplrefresh('./source/plugin/mobile/template/mobile.htm', './template/default/common/header.htm', 1445780000, 'mobile', './data/template/1_mobile_mobile.tpl.php', './source/plugin/mobile/template', 'mobile')
|| checktplrefresh('./source/plugin/mobile/template/mobile.htm', './template/default/common/footer.htm', 1445780000, 'mobile', './data/template/1_mobile_mobile.tpl.php', './source/plugin/mobile/template', 'mobile')
|| checktplrefresh('./source/plugin/mobile/template/mobile.htm', './template/default/common/header_common.htm', 1445780000, 'mobile', './data/template/1_mobile_mobile.tpl.php', './source/plugin/mobile/template', 'mobile')
|| checktplrefresh('./source/plugin/mobile/template/mobile.htm', './template/default/common/header_qmenu.htm', 1445780000, 'mobile', './data/template/1_mobile_mobile.tpl.php', './source/plugin/mobile/template', 'mobile')
|| checktplrefresh('./source/plugin/mobile/template/mobile.htm', './template/default/common/pubsearchform.htm', 1445780000, 'mobile', './data/template/1_mobile_mobile.tpl.php', './source/plugin/mobile/template', 'mobile')
;?>
...
<body id="nv_<?php echo $_G['basescript'];?>" class="pg_<?php echo CURMODULE;?><?php if($_G['basescript'] === 'portal' && CURMODULE === 'list' && !empty($cat)) { ?> <?php echo $cat['bodycss'];?><?php } ?>" onkeydown="if(event.keyCode==27) return false;" style="url(img/index/banner_bg.png) repeat;">
...
<div id="frt">
<p>Powered by <strong><a href="http://www.inbkj.com" target="_blank">创晓科技</a></strong> <em><?php echo $_G['setting']['version'];?></em><?php if(!empty($_G['setting']['boardlicensed'])) { ?> <a href="http://license.comsenz.com/?pid=1&amp;host=<?php echo $_SERVER['HTTP_HOST'];?>" target="_blank">Licensed</a><?php } ?></p>
<p class="xs0">&copy; 2014-2015 <a href="http://www.comsenz.com" target="_blank">Comsenz Inc.</a></p>
